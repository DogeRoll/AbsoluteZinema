...
{
    internal class PerformanceFix : IGraphicalFix
    {
        ...
        private void IL_Main_DoDraw(ILContext il)
        {
            ...
            {
                PatchDoDrawNext(c);
                Console.WriteLine($"{i}: cursor index - {c.Index}");
            }
        }
        ...
        private void IL_Main_DrawBlack(ILContext il)
        {
            ...
            c.GotoNext(MoveType.Before,
                ...
                i => i.MatchDiv());
            MethodInfo evalOffsetSub = typeof(PerformanceFix).GetMethod("EvalOffsetSubstraction", BindingFlags.Static | BindingFlags.NonPublic);
            c.Index += 2;
        ...
        private static int EvalOffsetSubstraction()
        {
            ...
            return EvalOffset(Main.screenWidth - Main.screenHeight) + 96;
        } 
    }
}
